...
def help(update, context):
    update.message.reply_text('Old Zona Croco 🦎 Əmrlər:\n' +
                              '/game - Yeni Bir Oyun Başladın\n' +
                              '/master @xoshgeldingulum Aparıcı Olmaq\n' +
...
def command_start(update, context: CallbackContext):
    if update.effective_chat.type == "private":
        ...
        addme = InlineKeyboardButton(text="🦎 Məni Qrupa əlavə et!", url="https://t.me/OldSchoolZonaCrocoBot?startgroup=a")
        kanal = InlineKeyboardButton(text="📣 Resmi Qrup", url="https://t.me/OldZona")
        admin = InlineKeyboardButton(text="🧑‍💻 Sahib", url="https://t.me/shirnovff")
        
        keyboard = [[addme],[kanal],[admin]]
        reply_markup = InlineKeyboardMarkup(keyboard)
        update.message.reply_text('Salam men Old Zona croco Bot\nMəni Grupa Qataraq Oyun Başlada Bilərsiniz\n\nDaha ətraflı /help', reply_to_message_id=True, reply_markup=reply_markup)
    else:
        ...
        update.message.reply_text('Old Zona Soz oyunu başladi!🦎'.format(username), reply_to_message_id=True)
