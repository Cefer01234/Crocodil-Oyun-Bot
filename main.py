...
def help(update, context):
    update.message.reply_text('Old School Zona 🦎 Əmrlər:\n' +
...
def command_start(update, context: CallbackContext):
    if update.effective_chat.type == "private":
        ...
        addme = InlineKeyboardButton(text="🦎 Məni Qrupa əlavə et!", url="https://t.me/OldSchoolZonaCrocodileBot?startgroup=a")
        ...
        update.message.reply_text('Old School Zona Söz Oyunu Başladi!🦎'.format(username), reply_to_message_id=True)
